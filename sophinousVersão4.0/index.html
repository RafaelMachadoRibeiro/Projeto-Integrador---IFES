        ...
        <div id="modal_login">
            <form class="form">
                <div class="form-control">
                    ...
                    <small>Mensagem erro</small>
                </div>



                <div class="form-control">
                    <input type="txtsenha" name="txtsenha" id="txtsenha" placeholder="Senha:">
                    <small>Mensagem erro</small>
                </div>
    ...
    <div id="modal_cadastro" class="hide">
        ...
        <div id="cadastro">
            <form class="form_cadastro">
                ...
                <div class="form-control">
                    <input type="date" name="txtdata" id="txtdata" placeholder="Data de Nacimento:">
                    <small>Mensagem erro</small>
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    <input type="txtCsenha" name="txtCsenha" id="txtCsenha" placeholder="Confirmar Senha:">
                    <small>Mensagem erro</small>
                </div>
